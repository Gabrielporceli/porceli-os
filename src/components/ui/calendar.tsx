    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 opacity-50 hover:opacity-100 transition-all border-white/10"
        ),
        ...
        head_cell:
          "text-white/40 rounded-md w-10 font-medium text-[0.85rem] uppercase tracking-wider",
